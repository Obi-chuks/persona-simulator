...
.app-pill {
    ...
    font-size:10px; letter-spacing:3px; color:#006632;
    border:1px solid #00a04a; padding:4px 14px; border-radius:20px; margin-bottom:12px;
}
.app-title {
    font-family:'DM Serif Display',serif;
    font-size:36px; color:#003318; line-height:1.1; margin-bottom:4px;
}
...
.user-bubble {
    ...
    padding: 13px 18px; max-width: 75%;
...
.persona-bubble {
    ...
    padding: 13px 18px; max-width: 100%;
    color: #1a2a1a !important;
    font-size: 14.5px; line-height: 1.65;
...
.avatar {
    ...
    background: linear-gradient(135deg, #006632, #004422);
...
.persona-tag {
    ...
    color:#006632; background:#e8f5ee; border:1px solid #a0d0b0;
...
.human-truth {
    background:#f0f8f2; border-left:3px solid #00a04a;
    padding:8px 12px; border-radius:0 8px 8px 0;
    font-size:12px; color:#2a5a3a !important; line-height:1.6; margin-top:6px;
}
...
.stTextInput > div > div > input {
    ...
    border: 1px solid #c0d8c0 !important;
...
.stButton > button {
    background: linear-gradient(135deg, #006632, #004a24) !important;
    border: 1px solid #00a04a !important;
    border-radius: 14px !important;
...
def call_azure(question):
    ...
    if r.status_code == 200:
        ...
        return answer_dict["response"], answer_dict.get("persona", ""), evaluator
    else:
...
# ── Header with BNP Paribas logo ─────────────────────────────────────────────
st.markdown("""
<div class="app-header">
    <div style="margin-bottom:16px;">
        <svg width="180" height="44" viewBox="0 0 180 44" fill="none" xmlns="http://www.w3.org/2000/svg">
          <!-- BNP Paribas wordmark recreation -->
          <!-- Green bar accent -->
